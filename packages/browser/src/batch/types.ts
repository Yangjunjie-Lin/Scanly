...
export type TrackEvent =
  | { type: "track-added"; track: BarcodeTrack }
  | { type: "track-updated"; track: BarcodeTrack }
  | { type: "track-lost"; trackId: string; track: BarcodeTrack }
  | { type: "track-restored"; track: BarcodeTrack }
  | { type: "track-retired"; trackId: string; track: BarcodeTrack };

export type BatchEvent =
  | TrackEvent
  | { type: "item-matched"; item: ExpectedBatchItem; track: BarcodeTrack }
  | { type: "unexpected-item"; track: BarcodeTrack }
  | { type: "duplicate-item"; item: ExpectedBatchItem; track: BarcodeTrack }
  | { type: "batch-completed"; state: BatchState }
  | { type: "batch-cancelled"; state: BatchState }
  | { type: "batch-failed"; state: BatchState; error: unknown };
