...
export class DecodeWorkerClient {
    ...
    handleMessage(message) {
        ...
        if (!job || message.jobId !== job.jobId || message.jobId !== this.currentJobId)
            return;
    ...
    async scan(frame, scenario, options = {}) {
        ...
        return new Promise((resolve) => {
            const job = { jobId, ...identity, postedAt: Date.now(), setupMs, resolve, onStage: options.onStage, onProgress: options.onProgress };
