...
Machine-readable benchmark contracts, conformance evaluation, and regression gates for Scanly SDK v2.1.0.
...
Version: 2.1.0 · [Benchmark methodology](https://github.com/Yangjunjie-Lin/Scanly/blob/main/docs/benchmarking/methodology.md)
