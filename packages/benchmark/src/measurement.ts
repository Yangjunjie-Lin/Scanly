import type { BenchmarkDistribution, BenchmarkFixtureResult, BenchmarkVariance } from "./types.js";
...
export function summarizeBenchmarkVariance(results: Array<Pick<BenchmarkFixtureResult, "elapsedMs" | "runTimingsMs">>): BenchmarkVariance {
...
export function summarizeIterationCorrectness(results: Array<Pick<BenchmarkFixtureResult, "pass" | "allPayloads" | "elapsedMs">>) {
  return {
