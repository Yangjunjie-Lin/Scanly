...
Versioned, runtime-validated capture scenarios for Scanly SDK v2.0.0. Schema `2.1` is current; valid `2.0` input is migrated deterministically and mixed old/new fields or unknown versions are rejected.
...
Version: 2.0.0 · [Scenario documentation](https://github.com/Yangjunjie-Lin/Scanly/blob/main/docs/scenarios/configuration.md)
