import { BinaryBitmap, HybridBinarizer, RGBLuminanceSource, DecodeHintType, BarcodeFormat, QRCodeReader, } from "@zxing/library";
let reader = null;
function getReader() {
    if (!reader)
...
export function decodeWithZXing(buffer) {
...
//# sourceMappingURL=zxing-decoder.js.map