...
export async function loadPixelBufferFromPath(filePath) {
    try {
        ...
        const buffer = createPixelBuffer(new Uint8ClampedArray(data.buffer, data.byteOffset, data.byteLength), info.width, info.height);
...
//# sourceMappingURL=image-loader-node.js.map