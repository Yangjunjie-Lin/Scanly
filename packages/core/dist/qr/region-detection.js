...
export function applyCropPadding(rect, imageWidth, imageHeight, padding) {
...
export function nonMaximumSuppression(regions, iouThreshold = 0.45, maxKeep = 5) {
 ...
 */
export function detectCandidateRegions(image, options) {
...
export function scaleRectToOriginal(rect, previewScale) {
...
//# sourceMappingURL=region-detection.js.map