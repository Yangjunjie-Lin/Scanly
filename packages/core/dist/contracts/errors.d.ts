export declare const SDK_ERROR_CODES: readonly ["no_symbol_found", "unsupported_format", "invalid_image", "resource_limit_exceeded", "timeout", "cancelled", "worker_initialization_failure", "engine_initialization_failure", "engine_execution_failure", "camera_permission_denied", "camera_not_found", "camera_busy", "camera_constraint_failed", "camera_track_ended", "camera_capability_unsupported", "camera_recovery_failed", "browser_background_suspended", "camera_unavailable", "source_disconnected", "unsupported_browser_capability", "malformed_scenario", "invalid_configuration", "internal_invariant_failure", "session_not_running", "session_disposed", "concurrent_call_rejected"];
