...
export function isValidRetailChecksum(value: string): boolean {
...
export function normalizeRetailBarcode(format: BarcodeFormat, value: string): RetailBarcodeMetadata | null {
