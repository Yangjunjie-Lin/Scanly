...
export interface RecoveryPlan {
  ...
  budget: RecoveryBudget;
  rejected: readonly { routeId: RecoveryRouteId; reason: string }[];
}
...
export type RecoveryDecodeExecutor = (
  frame: NormalizedFrame,
  request: { routeId: RecoveryRouteId; signal?: AbortSignal; remainingRecoveryAttempts: number },
