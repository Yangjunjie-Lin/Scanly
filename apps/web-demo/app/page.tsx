    ...
    <main className="row" style={{ flexDirection: "column", gap: 14 }}>
      <header className="row" style={{ alignItems: "baseline", justifyContent: "space-between" }}>
        <div>
          ...
          <div className="small">
            Browser-side Scanly SDK v2.1.0 barcode scanner with optional Link Intelligence, bounded frame scheduling, temporal confirmation, and multi-layer decoder fallbacks. Camera or
