...
Scanly SDK v2.0.0 classifies public APIs as Stable, Experimental, or Internal. `ScannerSession`,
...
rules. Breaking changes after v2.0.0 require a new major release and qualification cycle.
