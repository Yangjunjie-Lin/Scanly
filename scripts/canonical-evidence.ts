...
const ACCEPTED_BENCHMARK_SDK_VERSIONS = new Set(["2.0.0-rc.2", "2.0.0-beta.5"]);
...
export function validateSymbologyReport(
  ...
  if (report.sdkVersion !== "2.0.0-rc.2") failures.push("symbology SDK version is not 2.0.0-rc.2");
