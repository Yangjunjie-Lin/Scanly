...
if (pkg.name !== "scanly" || pkg.version !== "2.0.0-beta.3") fail("package metadata must identify the Scanly SDK v2 Beta 3 development platform");
...
if (!readme.includes("SDK-2.0.0--beta.3")) fail("README SDK badge does not match 2.0.0-beta.3.");
