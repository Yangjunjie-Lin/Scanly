...
if (pkg.name !== "scanly" || pkg.version !== "2.0.0-beta.2") fail("package metadata must identify the Scanly SDK v2 Beta 2 development platform");
...
if (!readme.includes("SDK-2.0.0--beta.2")) fail("README SDK badge does not match 2.0.0-beta.2.");
