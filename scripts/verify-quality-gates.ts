...
if (pkg.name !== "scanly" || pkg.version !== "2.0.0-rc.2") fail("package metadata must identify the Scanly SDK v2 RC2 software candidate");
...
if (!readme.includes("SDK-2.0.0--rc.2")) fail("README SDK badge does not match 2.0.0-rc.2.");
