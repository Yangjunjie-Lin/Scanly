...
if (pkg.name !== "scanly" || pkg.version !== "2.0.0-rc.1") fail("package metadata must identify the Scanly SDK v2 RC1 software candidate");
...
if (!readme.includes("SDK-2.0.0--rc.1")) fail("README SDK badge does not match 2.0.0-rc.1.");
