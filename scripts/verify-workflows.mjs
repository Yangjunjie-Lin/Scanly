...
for (const marker of ["release:", "types: [published]", "id-token: write", "secrets.NPM_TOKEN", "provenance: true", "libnpmpublish", "npm_internal_modules", "Waiting for Registry propagation", "git+https://github.com/Yangjunjie-Lin/Scanly.git", "v2.0.0", "verification.verified", "stable:manifest:verify -- --require-go"]) {
