...
async function main(): Promise<void> {
  ...
  const report = { schemaVersion: "beta3-industrial-soak-1", kind: "industrial-recovery-core-soak", sdkVersion: "2.0.0-rc.2", sourceCommit, sourceTree, repositoryDirty, workerEvidence: "not-applicable-core-soak", observed, failureReasons: failures.slice(0, 100), pass: failures.length === 0 };
