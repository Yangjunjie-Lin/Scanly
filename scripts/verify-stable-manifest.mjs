...
for (const marker of ["id-token: write", "secrets.NPM_TOKEN", "provenance: true", "libnpmpublish", "npm_internal_modules", "git+https://github.com/Yangjunjie-Lin/Scanly.git", "v2.0.0", "stable:manifest:verify -- --require-go"]) {
