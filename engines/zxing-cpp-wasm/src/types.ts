...
export type ZxingCppWasmErrorCode =
  | "asset_not_found"
...
export type ZxingCppWasmAssetResolver = (
  variant: ZxingCppWasmVariant,
  metadata: ZxingCppWasmBuildMetadata,
) => ZxingCppWasmAsset | Promise<ZxingCppWasmAsset>;
