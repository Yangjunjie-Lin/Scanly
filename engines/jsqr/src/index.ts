...
export class JsQrEngine implements DecoderEngine {
  ...
  readonly capabilities = { formats: ["qr_code" as const], formatClasses: ["matrix" as const], supportsMultiple: false, returnsRawBytes: true, supportsRawBytes: true, returnsCornerPoints: true, threadSafe: true, estimatedScratchBytesPerPixel: 5, copiesInputBuffer: false, supportsGs1: false, supportsOrientation: false, supportsInversion: true, runtimeKinds: ["browser", "worker", "node"] as const, executionModel: "javascript" as const };
